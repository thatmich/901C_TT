...
const int frontL_port = 2;
const int frontR_port = 10;
const int backL_port = 1;
const int backR_port = 9;
const int intakeL_port = 15;
const int intakeR_port = 12;
const int tray_port = 20;
const int lift_port = 19;
const int lift_limit_port = 8;
